...
function writeVersion() {
  ...
  // stamp; builder.js and pieces.json are fetched from script and pick the
  // version up from the meta tag.
  const content = ['catalog.json', 'catalog.css', 'catalog.js', 'builder.css', 'builder.js', 'previews.js', 'viewport.js', 'pieces.json']
